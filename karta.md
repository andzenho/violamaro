...
| `lending-strategiya-dizayna.md` | 7 988 | Лендинг «Практическая эмпатия 4.0» — стратегия дизайна |
...
| `praktikum-vnutrennie-zametki.md` | 30 550 ⚠️ | Практикум «Прикладная эмпатия» — внутренние заметки |
...
---
**Всего 203 файлов, ~994 273 токенов.** Весь репозиторий в один контекст не влезает и не должен.
