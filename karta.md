...
| `kanon-empat.md` | 3 775 | Канон Виолы. Тема эмпата (пробуждение и сила) |
...
| `kp/kabinet-predzapisi/` | 9 | 7 350 | КП Кабинет предзаписи |
...
## `docs/` — 5 файл., 120 867 ток.
*Опубликованное на GitHub Pages*

| Файл | Ток. | Суть |
|---|---:|---|
| `README.md` | 845 | docs/ — то, что опубликовано |
| `dizayn-testov.md` | 1 913 | Дизайн тестов и квестов — стандарт |
| `index.html` | 25 296 ⚠️ | — |
| `koleso/index.html` | 92 098 ⚠️ | — |
...
---
**Всего 199 файлов, ~954 411 токенов.** Весь репозиторий в один контекст не влезает и не должен.
