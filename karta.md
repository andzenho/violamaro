...
| Файл | Ток. | Суть |
|---|---:|---|
| `CLAUDE.md` | 2 212 | Проект «Виола Маро» |
| `README.md` | 1 195 | Виола Маро — рабочий репозиторий |

## `baza/` — 10 файл., 44 120 ток.
...
| `kanon-empat.md` | 2 332 | Канон Виолы. Тема эмпата (пробуждение и сила) |
...
| `kanon-viny.md` | 7 937 | Канон Виолы. Тема вины |
...
| `zhurnal-resheniy.md` | 1 203 | Журнал решений |

## `produkt/` — 31 файл., 208 712 ток.
...
| `lending-strategiya-dizayna.md` | 7 942 | Лендинг «Практическая эмпатия 4.0» — стратегия дизайна |
| `marafon-po-sferam.md` | 12 270 ⚠️ | Календарь запуска и пять эфиров |
...
| `praktikum-vnutrennie-zametki.md` | 30 321 ⚠️ | Практикум «Прикладная эмпатия» — внутренние заметки |
...
| `skript-prodazh-sozvon.md` | 5 251 | Скрипт созвона |
...
| `transformatsii.md` | 2 036 | Канон трансформаций «Виола» |
| `transformatsiya-za-dengi.md` | 2 834 | Трансформация за деньги: какую метаморфозу продавать для максимальной в… |
...
| `ca-master.md` | 13 786 ⚠️ | ЦА под продажу «Прикладной эмпатии» — мастер-сводка |
| `ca-portret.md` | 4 962 | Кто наш покупатель. Объяснение для команды |
| `ca-voc.md` | 6 871 | Voice-of-customer: банк дословных фраз аудитории |
...
|---|---:|---:|---|
| `kp/bot-rassylki/` | 6 | 1 353 | КП Бот рассылки |
| `kp/kabinet-predzapisi/` | 7 | 5 100 | КП Кабинет предзаписи |
| `kp/staryy-kanal-chat/` | 4 | 1 819 | КП Старый канал + чат |
| `kp/storis-insta-tiktok/` | 3 | 1 113 | КП Сторис Инста+ТикТок |
| `kp/tg-osnova/` | 33 | 10 393 | КП Телеграм Основа |

## `korpus/` — 14 файл., 292 591 ток.
...
## `docs/` — 6 файл., 116 134 ток.
*Опубликованное на GitHub Pages*

| Файл | Ток. | Суть |
|---|---:|---|
| `README.md` | 872 | docs/ — то, что опубликовано |
| `dizayn-testov.md` | 1 913 | Дизайн тестов и квестов — стандарт |
| `index.html` | 25 296 ⚠️ | — |
| `koleso/index.html` | 85 949 ⚠️ | — |
...
`bot_probe.py`, `ca_sync.py`, `karta.py`, `karta_korpusa.py`, `kontrast.py`, `kp_export.py`, `lending_promt.py`, `oglavlenie.py`, `perenos.py`, `plan.py`, `proverka.py`, `razbor.py`, `razbor_kommentov.py`, `sheets_sync.py`, `tg_comments.py`, `ves.py`, `yt_comments.py`, `yt_stats.py`
...
Команды: `/den`, `/dyrki`, `/post`, `/proverka`, `/sait`, `/transkript`
...
---
**Всего 180 файлов, ~941 079 токенов.** Весь репозиторий в один контекст не влезает и не должен.
