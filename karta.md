...
| `kp/tg-osnova/` | 37 | 15 136 | КП Телеграм Основа |
| `kp/youtube/` | 3 | 2 447 | КП Ютуб |
...
---
**Всего 196 файлов, ~989 621 токенов.** Весь репозиторий в один контекст не влезает и не должен.
