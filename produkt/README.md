...
- `praktikum-dlya-empatov.md` — **источник правды.** Оффер, шесть недель, тарифы по окнам продаж (от 14 900 / 29 900 / 59 900 на предзаписи), плюс внутренние заметки: канон тарифной сетки, правки Виолы по голосу, арифметика её часов, открытые вопросы, риски.
