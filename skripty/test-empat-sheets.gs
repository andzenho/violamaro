...
var KL_LEAD_HEADERS = [
  ...
  'Согласие на ПД', 'Реклама', 'Время акцепта', 'Ред. согласия',
  /* Способ оплаты стоит последним намеренно: колонку, дописанную в конец,
     getSheet2_ добавит к уже существующему листу, не сдвигая старые строки. */
  'Способ оплаты'
];
...
/**
 * Лид-форма перед оплатой события «Неудобная».
 *
