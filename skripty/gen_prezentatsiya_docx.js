...
const tHead = () => new TableRow({
  ...
  children: [
    ...
    cell([
      ...
      P("Плюс разбор с Виолой", { italics: true, size: 17, color: "CFC8DC", align: AlignmentType.CENTER, after: 60 }),
    ...
    cell([
      ...
      P("Плюс ответ лично вам", { italics: true, size: 17, color: "EFD9E4", align: AlignmentType.CENTER, after: 60 }),
...
const tariffTable = new Table({
  ...
  rows: [
    ...
    groupRow("Со второго тарифа — отдельная встреча с Виолой сверх программы"),
    featRow("Зум с Виолой: любовь и деньги", "Отдельная встреча сверх шести занятий. Разбираем главное: как ваша суперспособность работает в отношениях и в деньгах", [0,1,1]),
    groupRow("Только в личном — Виола отвечает вам"),
    featRow("Зум с Виолой: ответы на ваши вопросы", "Ещё одна встреча: вы приносите свой вопрос, Виола отвечает в эфире", [0,0,1]),
    featRow("Персональное аудио от Виолы", "Ваш вопрос — её ответ голосом лично вам. То самое, за чем к ней и идут", [0,0,1]),
...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      H3("Ждём от Виолы"),
      BULLET("Одно число: сколько персональных аудио она делает за поток. Это и есть лимит мест в «Личном». Придуманный лимит не публикуем."),
      BULLET("Подтверждение двух зумов сверх программы: «любовь и деньги» на 7-й неделе и «ответы на вопросы» на 8-й."),
