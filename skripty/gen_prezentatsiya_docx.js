...
const tariffTable = new Table({
  ...
  rows: [
    ...
    featRow("6 лекций Виолы", "Две в неделю: от «куда уходят ваши силы» до «деньги и своё дело». Смотреть когда удобно, в своём часовом поясе", [1,1,1]),
...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      P("Шесть лекций Виолы выходят два раза в неделю: одна в середине недели, одна на выходных. Смотрите когда удобно, из любой точки мира и в своём часовом поясе. К каждой лекции есть аудиоверсия: можно слушать в дороге и на прогулке."),
