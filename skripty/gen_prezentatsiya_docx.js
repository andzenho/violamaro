...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      P("ПЕРВЫЙ ПОТОК · 4-НЕДЕЛЬНЫЙ АВТОРСКИЙ ОНЛАЙН-ПРАКТИКУМ ВИОЛЫ МАРО ДЛЯ ЭМПАТОВ",
      ...
      P("6 лекций Виолы · живой мастер-класс · месяц практики · доступ к материалам навсегда",
