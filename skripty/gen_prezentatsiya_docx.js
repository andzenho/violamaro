...
const tHead = () => new TableRow({
  ...
  children: [
    ...
    cell([
      ...
      P("Плюс личная встреча", { italics: true, size: 17, color: "EFD9E4", align: AlignmentType.CENTER, after: 60 }),
...
const tariffTable = new Table({
  ...
  rows: [
    ...
    featRow("Личная встреча с Виолой", "Час один на один. Ваша ситуация, ваши вопросы, ваша доска желаний", [0,0,1]),
...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      P("Вы чувствуете сильнее других. Это ваш радар, и он у вас с рождения. Вы видите людей насквозь. Слышите, когда человек говорит одно, а внутри у него другое. Замечаете то, чего другие не видят вовсе."),
      P("Вот только инструкции к этому радару вам никто не выдал. И вот он всю жизнь работает на всех вокруг. Отсюда и усталость, и пустота к вечеру."),
      ...
      H3("Ждём от Виолы"),
      BULLET("Одно число: сколько личных встреч она берёт за поток. Это и есть лимит мест в «Личном». Придуманный лимит не публикуем."),
      ...
      BULLET("Шаг между тарифами меньше воспринимаемой прибавки: +10 000 за её голосовые ответы весь поток против разовой консультации в 200 евро. Верхний шаг +20 000 за час один на один — ровно в цену консультации, поэтому держим его содержанием: личная встреча заявлена как разбор вашей доски желаний."),
