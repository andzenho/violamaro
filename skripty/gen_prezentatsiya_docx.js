...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      BULLET("Выслушали человека и остались полны сил. Вечер по-прежнему ваш."),
      BULLET("Спокойно говорите «нет». И остаётесь собой рядом с любым человеком."),
      BULLET("Ваш радар работает на вас: видите верный шаг, нужного человека, свою дверь."),
      BULLET("Позволяете себе получать: деньги, помощь, благодарность."),
      BULLET("Занимаетесь тем, что по душе, и это приносит деньги."),
      BULLET("Чувствуете свою силу и свою опору. «У меня есть Я»."),
      BULLET("Живёте свою жизнь, а не чужую. Тепла хватает и близким, и себе."),
      BULLET("Появляются время и силы на то, что радует именно вас."),
